...
\begin{purpose}
  Get used to working commutation problems on spinors.  Note that I
  (inappropriately) use $\psi$ instead of $\alpha$ but that's a
  distinction that doesn't really end up mattering until later in the
  chapter.
\end{purpose}
...
\begin{answer}
  ...
  \begin{answerpart}{Commutation}
    ...
    \begin{equation}
      \eval{[S_i, S_j] = i \hbar S_k}_{(i, j, k) \in \{(x, y, z),  (y, z, x),  (z, x, y)\}}
    \end{equation}
    ...
    \begin{equation}
      ...
      \begin{split}
        ...
        &=
        i \frac{\hbar^2}{4}
        \left( (-\Lambda_- + \Lambda_+) - (\Lambda_- - \Lambda_+) \right)
        \\
        &= i \frac{\hbar^2}{4}
        \left( (-\Lambda_- + \Lambda_+) + (-\Lambda_- + \Lambda_+) \right) \\
        &= i \frac{\hbar^2}{4} \left( 2 (\Lambda_+ - \Lambda_-) \right) \\
        &= i \hbar \left( \frac{\hbar}{2} (\Lambda_+ - \Lambda_-) \right) \\
        &= i \hbar S_z \qed{}\\
      \end{split}
    \end{equation}
    ...
    \begin{equation}
      ...
      \begin{split}
        ...
        &=
        \left[i \frac \hbar 2 (\ket - \bra + - \ket + \bra -)\right]
        \left[\frac \hbar 2 (\Lambda_+ - \Lambda_-)\right]
        -
        \left[\frac \hbar 2 (\Lambda_+ - \Lambda_-)\right]
        \left[i \frac \hbar 2 (\ket - \bra + - \ket + \bra -)\right]
        \\
    ...
    \begin{equation}
      ...
      \begin{split}
        ...
        \frac{\hbar^2}{4}
        \left(
        [(\Lambda_+ - \Lambda_-)][(\ket - \bra + + \ket + \bra -)]
        -
        [(\ket - \bra + + \ket + \bra -)][(\Lambda_+ - \Lambda_-)]
        \right)
        \\
        &=
        \frac{\hbar^2}{4}
