...
\begin{purpose}
  ...
  \outref{1}{11}{theQuestion}, but we can at least rob some of the math.
\end{purpose}
...
\begin{answer}
  ...
  \begin{answerpart}{Maximus Dipersionus Uncertainus}
    ...
    combination of operators.  In problem \outref{1}{11}{theQuestion} we
    ...
    \outref{1}{11}{spinAngle}, we found the eigenvectors of this
    ...
    \outref{1}{11}{spinAxes} (or figure \qref{spinAxes} in the \ac{qrf}).
