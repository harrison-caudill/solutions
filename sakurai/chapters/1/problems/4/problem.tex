...
\begin{purpose}
  Get some practice and familiarity with the Pauli spin operators,
  matrices, traces, etc.
\end{purpose}
...
\begin{answer}
  ...
  \begin{answerpart}{Elements}
    ...
    \begin{equation}
      \begin{split}
        a_0 &= \frac{1}{2}(X_{11} + X_{22})\\
        a_1 &= \frac{1}{2}(X_{12} + X_{21})\\
        a_2 &= \frac{i}{2}(X_{12} - X_{21})\\
        a_3 &= \frac{1}{2}(X_{11} - X_{22})\\
      \end{split}
    \end{equation}
