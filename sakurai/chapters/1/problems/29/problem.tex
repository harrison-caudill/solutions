...
\begin{answer}
  ...
  \outref{1}{6}{theQuestion} equation \outref{1}{6}{kittens}.  Buuut,
  just like we did back in \outref{1}{6}{theQuestion}, we're going to
  assume that it can be written as a Taylor series.  If that's the
  case, then we can pull in equation \qref{taylor:exponential} and
  show that
  ...
  \begin{answerpart}{Unitarius Continuous}
    ...
    that or you're using the fundamental relation $\dd{X} = \sum
    \pdv{}{x_i}X \dd{x_i}$).  In this case, I believe it's pretty
