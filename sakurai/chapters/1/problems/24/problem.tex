...
\begin{purpose}
  ...
  OK... I'm changing my answer here... this problem is a real troll.
  This is a capstone problem for the chapter.  You get a little bit of
  everything including disagreement amongst physicists about how to
  solve it.
...
\begin{answer}
  ...
  \begin{answerpart}{The ``normal'' way}
    ...
    fall-time.  In a subsequent solution, we're going to exmaine what
    ...
    Just for funsies, let's see what happens when we evaluate this
    puppy at $d = 10^{-25}m$, $L = 10cm$, and $m = 0.1kg$. Drumroll
    everyone... My python script comes back with... $2.998s$...  I'm
    going to sleep now.
