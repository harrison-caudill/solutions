...
\begin{purpose}
  Get intimately familiar with the derivation of the unitary rotation
  operator.  You're just going to derive it from scratch.  Have fun.
\end{purpose}

\begin{answer}

  Grumble grumble grumble... stupid problem... grumble
  grumble... already saw rotation operators... baa
  humbug... grumble...
...
Putting in our Eigenvalues, and solving for $\alpha_\pm$
  ...
  To make sure we stick with the conventions defined by Sakurai in the
  problem, we'll go ahead and assign the positive side to be:

  \begin{equation}
    \begin{alignedat}{2}
      & &
      \Lambda_+\ket{\alpha_+} &= \cos(\frac \beta 2)\ket +\\
      \Rightarrow \quad & &
      \alpha_+ &= \cos(\frac \beta 2)\\
    \end{alignedat}
  \end{equation}

  Then solving for the $\ket -$ coefficient ($\alpha_-$)

  \begin{equation}
    \begin{split}
      \frac{\alpha_+}{\alpha_-}
      &= e^{-i\alpha}\frac{\cos{\frac{\beta}{2}}}{\sin{\frac{\beta}{2}}}\\
      \frac{\cancel{\cos{\frac{\beta}{2}}}}{\alpha_-}
      &= e^{-i\alpha}
      \frac{\cancel{\cos{\frac{\beta}{2}}}}{\sin{\frac{\beta}{2}}}\\
      \alpha_- &= e^{i\alpha}\sin{\frac{\beta}{2}}\\
    \end{split}
  \end{equation}
  ...
  you know, some acetone or some strychnine or something.
