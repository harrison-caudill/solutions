...
\begin{answer}
  ...
  \begin{answerpart}{With LinAlg}
    ...
    Drawing upon our experience in \outref{1}{26}{theQuestion}, we can
    do this one pretty easily too\footnote{Check out equation
    \outref{1}{26}{yzExpression} where we do this for y which differs
    only by a factor of $i$.}
    ...
    Ladies and gentlemen, it looks like we have ourselves a
