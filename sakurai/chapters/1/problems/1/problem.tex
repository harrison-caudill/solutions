\begin{question}
  ...
  thermal distribution. The beam moves through a one-meter long
  magnetic field with a vertical gradient 10 Bohr magnetons, and
  impinges a screen one meter downstream of the end of the
  magnet. Assuming the silver atom has spin $\frac 1 2$ with a
  magnetic moment of one Bohr magneton, find the separation distance
  in millimeters of the two states on the screen.

\end{question}

\begin{purpose}
  I think he's wanting us to get accustomed to the concept of
  macroscopic effects with quantum implications.
\end{purpose}
