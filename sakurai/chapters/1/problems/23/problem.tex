...
\begin{purpose}
  We're connecting wave mechanics with Bra/Ket algebras and ensuring
  the restrictions of the uncertainty relations hold.  You probably
  see a trend here, where Sakurai introduces a tool, has us practice
  with the tool, then connects it to another tool, then to reality or
  to a new concept etc.  You're probably also thinking about the $n^2$
  growth of node-connections as you add more nodes...  In the words of
  a friend: ``Don't worry, it's worse than you think.''
\end{purpose}
...
\begin{answer}
  ...
  \begin{answerpart}{You're Grounded Mr}
    ...
    Recalling our trig identity from equation \qref{trig:cos2a}
