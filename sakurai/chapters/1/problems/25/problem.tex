...
\begin{purpose}
  ...
  here after having finished problem \outref{1}{24}{theQuestion} which
  was the capstone problem for the chapter so... yeah... be a bit
...
\begin{answer}
  ...
  \begin{answerpart}{More degenerates?}
    ...
    \begin{equation}
      \begin{alignedat}{2}
        ...
        \\
        &&&=
        \lambda^2(b-\lambda) - b^2(b-\lambda)
        \\
        &&&=
        (b - \lambda)
        (\lambda^2 - b^2)
  ...
  \begin{answerpart}{Morning Commute}
    ...
    problem...umm... \outref{1}{17}{theQuestion}.
  \end{answerpart}

  \begin{answerpart}{Perfect Union}

    Since we know the two operators commute, the easiest thing to
    articulate is reference equation \outref{1}{17}{result} in problem
    \outref{1}{17}{theQuestion} and rewrite the product of the
    operators as:
