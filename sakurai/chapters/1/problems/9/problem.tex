\begin{question}
  ...
  \begin{questionpart}
    Illustrate (a) and (b) using $A$ set equal to $S_z$ of a sping $\frac 1 2$ system.
  \end{questionpart}
...
\begin{answerpart}{Null Operator}
  ...
  \begin{equation}
    A^\dagger = A = \left. \sum_i a_i\Lambda_i, \text{ where } a_i \ne a_j \right|_{i \ne j}
  \end{equation}
