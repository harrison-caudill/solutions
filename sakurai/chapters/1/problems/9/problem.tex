\begin{question}
  ...
  \begin{questionpart}
    Illustrate (a) and (b) using $A$ set equal to $S_z$ of a spin
    $\frac 1 2$ system.
  \end{questionpart}
...
\begin{purpose}
  This is the first problem where we really start to analyze things in
  Bra/Ket algebras, and as you'll see below, I learned a valuable
  lesson about doing so.
\end{purpose}
...
\begin{answerpart}{Grind it Out for \texorpdfstring{$S_z$}{Sz}}
