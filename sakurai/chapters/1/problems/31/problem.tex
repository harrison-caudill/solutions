...
\begin{purpose}
  ...
  \outref{1}{30}{theQuestion}.  This one might actually be easy... mostly
...
\begin{answer}
  ...
  \begin{answerpart}{``Easily''}
    ...
    See the derivation of equation \outref{1}{30}{xfp} for
    \begin{equation}
      [x_i, G(\vb{p})] = i\hbar \pdv{G}{p_i}
    \end{equation}
    ...
    \outref{1}{30}{ConstantPower} and refine it further
    ...
    equations \outref{1}{30}{presub} and \outref{1}{30}{postsub} and
    we, entirely expectedly, get the same result (just with a negative
