...
\disputed{Let's face it...my ``solution'' is wrong...either that or
  every emag solver in the world is wrong, so let's just assume that I
  am shall we?  The problem is that I can't find any errors.
  My solution disagrees with other external solutions in that
